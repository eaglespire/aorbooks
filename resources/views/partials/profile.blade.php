...
<div class="jumbotron">
    <div class="row justify-content-center">
        <div class="col-lg-3">
            <figure class="figure">
                <img src="{{ asset('storage/users/'.auth()->user()->profile->image ? auth()->user()->profile->image : '') }}" class="figure-img img-fluid rounded" alt="...">
        ...
        <div class="col-lg-8">
            ...
            <a href="{{ route('profile.create') }}" class="btn btn-success float-md-right">
