...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <div class="jumbotron jumbotron-fluid" style="background-image: url({{ asset('images/old-books-436498_640.jpg') }});  background-position: center; background-repeat: no-repeat; background-size: cover">
            <div class="container">
